...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Dernières pièces <span>pièces de créateur</span> <span>achat-vente</span> <span>prix cassés</span> <span>marques de luxe</span></h2>
		<?php
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap - été 2022 <span>pièces de créateur</span> <span>achat-vente</span> <span>prix cassés</span> <span>marques de luxe</span></h2>
